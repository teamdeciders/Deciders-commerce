    ...
    return (
        <div className="w-full mt-8">
            <div className='flex gap-20'>
                ...
                <Link className="ml-4 " to={''}> <span className=' flex items-center bg-success border border-[#E5E5E5] h-[50px] w-[220px] mb-3 rounded-lg font-semibold hover:bg-white hover:border-success'><RiListSettingsLine className='block text-xl mr-4 ml-4' /> Dashboard</span> </Link>
                <h1 className='text-4xl font-bold text-success'>Hello Rosie!</h1>
            </div>
            <div className='lg:max-w-7xl md-w-full  mx-auto md:flex gap-2'>
                <div className='md:w-[22%] md:max-h-max h-full  p-3'>


                    <Link to={''}> <span className=' flex items-center border border-[#E5E5E5] h-[50px] w-[220px] mb-3 rounded-lg font-semibold'><BsBag className='block text-xl mr-4 ml-4' /> Orders</span> </Link>
                ...
                <div className='md:w-[80%] rounded-md  shadow p-2 '>
                    {/* Out let Here */}
